                    ...
                    <div class="row gx-lg-5 align-items-center">
                        <div class="col-lg-6 mb-5 mb-lg-0">
                            ...
                            <p style="color: hsl(217, 10%, 50.8%)">
                                ...
                                the latest phone when you can find it on the Internet in a single click?
                                Not only mobiles. Flipkart houses everything you can possibly imagine,
                                from trending electronics like laptops, tablets, smartphones, and mobile
                                accessories to in-vogue fashion staples like shoes, clothing and lifestyle
                                accessories; from modern furniture like sofa sets, dining tables, and wardrobes
                                to appliances that make your life easy like washing machines, TVs, ACs, mixer grinder 
                                ...
                                it, and you can stay assured about finding them all here. For those of you with erratic working hours, Flipkart 
                                is your best bet. Shop in your PJs, at night or in the wee hours of the morning. This e-commerce never shuts down.
                            </p>
                        </div>
                                ...
                                <div class="card-body py-5 px-md-5">
                                    ...
                                    <form action="SignupServlet" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="form-outline">
                                                    <input type="tel" id="form3Example2" name="phone" class="form-control" />
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <textarea id="form3Example2" name="address" class="form-control" ></textarea>
